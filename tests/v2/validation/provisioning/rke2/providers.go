...
func CreateProvider(name string) Provider {
	...
	case name == awsProviderName:
		provider := Provider{
			Name:                  name,
			MachineConfigPoolType: machinepools.AWSPoolType,
	...
	case name == azureProviderName:
		provider := Provider{
			Name:                  name,
			MachineConfigPoolType: machinepools.AzurePoolType,
	...
	case name == doProviderName:
		provider := Provider{
			Name:                  name,
			MachineConfigPoolType: machinepools.DOPoolType,
	...
	case name == linodeProviderName:
		provider := Provider{
			Name:                  name,
			MachineConfigPoolType: machinepools.LinodePoolType,
	...
	case name == harvesterProviderName:
		provider := Provider{
			Name:                  name,
			MachineConfigPoolType: machinepools.HarvesterPoolType,
