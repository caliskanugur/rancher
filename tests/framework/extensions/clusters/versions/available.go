...
func ListRKE2AvailableVersions(client *rancher.Client, cluster *v1.Cluster) (availableVersion []string, err error) {
	...
	for i, version := range allAvailableVersions {
		if strings.Contains(version, cluster.Spec.KubernetesVersion) {
...
func ListK3SAvailableVersions(client *rancher.Client, cluster *v1.Cluster) (availableVersion []string, err error) {
